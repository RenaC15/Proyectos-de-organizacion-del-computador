...
puntoGain2:
	...
	li $t1, 4        # línea central
        li $t2, 2        # columna cerca del lado izquierdo (jugador 1)
        li $t3, 1        # dirección vertical (puedes alternar)
        li $t6, 1        # dirección horizontal: 1 -> mover a la derecha (hacia jugador 2)
        li $t0, 1
	j InicioRonda
